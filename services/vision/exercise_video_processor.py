...
from detectors.push_ups import PushUpsDetector
...
class VideoProcessorClass(VideoProcessorBase):
    def __init__(self):
        ...
        self._landmarkers = vision.PoseLandmarker.create_from_options(options)
    ...
    def _draw_no_pose_warnings(self, img):
        ...
        cv2.putText(
            img,
            "Move into frame and ensure full body is visible.",
            (30, 100),
            cv2.FONT_HERSHEY_SIMPLEX,
            1,
            (255, 255, 255),

...
class ShoulderPressDetector(BaseExercise):
    ...
    def process(self, landmarks):
        ...
        key_landmarks_visible = landmarks[shoulder_idx].visibility > self.MIN_VISIBILITY and landmarks[knee_idx].visibility > self.MIN_VISIBILITY and landmarks[wrist_idx].visibility > self.MIN_VISIBILITY

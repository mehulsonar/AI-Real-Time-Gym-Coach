...
class SquatDetector(BaseExercise):
    ...
    def process(self, landmarks):
        ...
        key_landmark_visible = landmarks[hip_idx].visibility >= self.MIN_VISABILITY and landmarks[knee_idx]. visibility >= self.MIN_VISABILITY and landmarks[ankle_idx].visibility >= self.MIN_VISABILITY
